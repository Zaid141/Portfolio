...
const marker2 = L.marker([39.9526, -75.1652], {icon:mic}).addTo(map); // Philadelphia, USA
marker2.bindPopup(
...
const marker3 = L.marker([24.5239, 54.4346], {icon:mff}).addTo(map); //NYUAD, UAE
marker3.bindPopup(
...
const marker4 = L.marker([46.2044, 6.1432], {icon:comic}).addTo(map); // Geneva, Switzerland
marker4.bindPopup(
...
const marker5 = L.marker([ 	31.463618, 74.383672], {icon:aboutme}).addTo(map); //Lahore,Pakistan
marker5.bindPopup(
